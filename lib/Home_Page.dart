  ...
  Widget build(BuildContext context) {
    ...
    Future getData() async {
      ...
      QuerySnapshot snapshot =
          await firestore.collection('latest').getDocuments();
      return snapshot.documents;
    }

    Future getLatestShortClips() async {
      final firestore = Firestore.instance;
      QuerySnapshot latestShortClips = await firestore
          .collection("latestShortClips")
          .where("isLatest", isGreaterThan: 0)
    ...
    Future getMovies() async {
      final firestore = Firestore.instance;
      QuerySnapshot moviesList = await firestore
          .collection('movies')
          .getDocuments(); // "moviesList" data ko access krnay kay liay ha...
      return moviesList.documents;
    }

    Future getTrailers() async {
      final firestore = Firestore.instance;
      QuerySnapshot trailersList =
          await firestore.collection('latestTrailers').getDocuments();
    ...
    Future getInterviews() async {
      final firestore = Firestore.instance;
      QuerySnapshot trailersList =
          await firestore.collection('latestInterviews').getDocuments();
      return trailersList.documents;
    }
    ...
    Future getSeasonList() async {
      final firestore = Firestore.instance;
      QuerySnapshot trailersList =
          await firestore.collection('seasonlist').getDocuments();
      return trailersList.documents;
    }

    routeToDetail(DocumentSnapshot info, String listName) {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => DetailPage(info, listName)));
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical:20.0), // Adjust the padding values as needed
                child: Column(
                  children: [
                    Heading('News'),
                    Container(
                                        ...
                                        builder: (context) =>
                                            EpisodeDetailsPage(
                                                snapshot.data[index]
                                                    .data['episodeNo']
                                                    .toString(),
                                                snapshot.data[index].data['il']
                                                    .toString(),
                                                snapshot.data[index]
                                                    .data['description']
                                                    .toString(),
                                                snapshot
                                                    .data[index].data['link']
                                                    .toString(),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Hero(
                                          tag:
                                              "latest${snapshot.data[index].data['name']}",
                                          child: Container(
                                            height: 170,
                                            width: 240,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Hero(
                                          tag:
                                              "movies${moviesList.data[index].data['name']}",
                ...
                child: Container(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, latestShortClips) {
                      if (latestShortClips.connectionState ==
                          ConnectionState.waiting) {
                        return Center(child: CircularProgressIndicator());
                      } else {
                        return ListView.builder(
